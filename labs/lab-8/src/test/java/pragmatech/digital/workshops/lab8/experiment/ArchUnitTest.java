...
import pragmatech.digital.workshops.lab8.controller.ThreadController;
...
class ArchUnitTest {
  ...
  static final ArchRule layeredArchitectureRuleShouldBeRespected = layeredArchitecture()
    ...
    .ignoreDependency(ThreadController.class, pragmatech.digital.workshops.lab8.repository.BookRepository.class);
